...
//   // close pin suggestions on outside click
//   useEffect(() => {
//     const handler = (e) => {
...
//   // select a locality from dropdown → add its pincode
...
//   // add pincode directly (manual entry)
//   const addPincode = () => {
...
//   // get display label for a saved pincode (locality name if known)
...
//                 <button onClick={() => photoRef.current.click()} className="px-4 py-2.5 rounded-xl border-2 border-slate-100 bg-slate-50 hover:border-blue-200 text-xs font-black text-slate-600 transition-all">
//                   Choose Photo
//                 </button>
//                 <button
//                   onClick={uploadPhoto}
...
//                 <span>2 km</span>
//                 <span>Bookings within this radius will show your profile</span>
//                 <span>50 km</span>
//               </div>
//             </div>

//             {/* ── SERVICEABLE AREAS / PINCODES ── */}
//             <div className="mb-5">
//               <label className="text-[10px] font-black text-slate-500 uppercase tracking-wider mb-1 block">
//                 Serviceable Areas
//               </label>
//               <p className="text-[10px] text-slate-400 mb-3">
//                 Search by area name (Dharampeth, Jaripatka…) or type a pincode directly
//               </p>

//               {/* saved pincodes as chips */}
...
//                       {getPincodeLabel(pin)}
//                       <button onClick={() => removePincode(pin)} className="hover:text-red-500 transition-colors ml-0.5">
...
//                     onKeyDown={e => {
//                       if (e.key === "Enter") {
//                         // if it's a pincode number, add directly; else try first suggestion
//                         if (/^\d{5,6}$/.test(pincodeInput.trim())) {
//                           addPincode();
//                         } else if (filteredLocalities.length > 0) {
//                           selectLocalityForPincode(filteredLocalities[0]);
//                         }
//                       }
//                     }}
...
//                     {/* MANUAL PINCODE SECTION at bottom */}
...
//                         Can't find your area above? Type the pincode directly and press Add.
//                       </p>
//                     </div>
//                   </div>
//                 )}
...
//                   Turn on to be shown as fallback when no nearby provider is found
//                 </p>
//               </div>
//               <button
//                 onClick={() => setWillingToTravel(prev => !prev)}
//                 className={`relative w-12 h-6 rounded-full transition-all flex-shrink-0 ${willingToTravel ? "bg-blue-600" : "bg-slate-300"}`}
//               >
//                 <span className={`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow transition-all ${willingToTravel ? "left-6" : "left-0.5"}`} />
//               </button>
//             </div>
//           </div>
